...
export const GOVCLOUD_PREPROD_TOKEN_URL = 'https://account-iam.awsg.usge1.private.platform.prep.ibmforusgov.com';
export const GOVCLOUD_PROD_TOKEN_URL = 'https://account-iam.awsg.usge1.private.platform.ibmforusgov.com';
export const AUTH_AWS_URLS = {
